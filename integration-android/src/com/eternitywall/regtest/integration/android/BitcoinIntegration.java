...
package com.eternitywall.regtest.integration.android;
...
public final class BitcoinIntegration {
    ...
    private static final String MIMETYPE_PAYMENTREQUEST = "application/vtkn-paymentrequest"; // BIP 71
    ...
    private static Intent makeBitcoinUriIntent(final String address, final Long amount) {
        final StringBuilder uri = new StringBuilder("vtkn:");
        if (address != null)
            uri.append(address);
        if (amount != null)
            uri.append("?amount=")
    ...
    private static void redirectToDownload(final Context context) {
        ...
        final Intent marketIntent = new Intent(Intent.ACTION_VIEW,
                Uri.parse("market://details?id=com.eternitywall.regtest"));
